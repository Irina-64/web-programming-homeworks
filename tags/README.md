# Домашнее задание к лекции 2. «Структура html-документа. Понятие тега. Типы тегов. Атрибуты»
Домашнюю работу выполните в редакторе по ссылке [«Домашняя работа к лекции 2»](https://codepen.io/Irina64/pen/eYqVJvo)
